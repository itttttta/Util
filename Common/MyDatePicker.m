...
-(id)init
{
    self = [super init];
    if (self) {
        _backgroundView = [UIView createViewWithFrame:CGRectMake(0, SCREEN_HEIGHT, SCREEN_WIDTH, SCREEN_HEIGHT)
                                      backgroundColor:KCOLOR_CLEAR];
        [[UIApplication sharedApplication].keyWindow addSubview:_backgroundView];
        
        UIView *blankView = [UIView createViewWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, SCREEN_HEIGHT-PickerHeight-KHEIGHT_40)
                                        backgroundColor:KCOLOR_CLEAR];
